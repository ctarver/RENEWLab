classdef ACLR_Sim < handle
    ...
    methods
        function obj = ACLR_Sim(p)
            if nargin == 0
                channel_leaern_simulation;
                return;
            end
        ...
        function run(obj)
            ...
            obj.v3_ue_rx_raw = obj.ues.rx(ue_rx);  % Arg is ignored if real array.
            ...
            %obj.v21_pre_out = bypass_precoder.use(obj.v0_downlink_data);
